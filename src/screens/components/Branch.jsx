        ...
        <div>
            <div className="w-full bg-white rounded-lg float-right py-5">
                ...
                <div class="w-10/12 ml-10 mt-16 bg-white rounded-lg relative">
                    <a href="#" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-full h-40">
                        <div class="relative w-full md:w-64 h-96 md:h-40">
                            <img class="object-cover w-full h-full rounded-t-lg md:rounded-none md:rounded-s-lg bg-slate-100 text-center" src="https://www.hollywoodreporter.com/wp-content/uploads/2015/12/got-iconic-images-18_2.jpg?w=3000" alt="Singular branch" />
                        </div>
                        <div class="flex flex-col justify-between p-4 leading-normal">
                            <h5 class="mb-2 text-xl tracking-tight text-[#5D6679] poppins-5">Singular Branch</h5>
                ...
                <div className="w-10/12 ml-10 mt-10 bg-white rounded-lg relative">
                    <a href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-full h-40 ">
                        <div className="relative w-full md:w-64 h-96 md:h-40">
                            <img className="object-cover w-full h-full rounded-t-lg md:rounded-none md:rounded-s-lg bg-slate-100 text-center" src="https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg" alt="Singular branch" />
                        </div>
                        <div className="flex flex-col justify-between p-4 leading-normal">
                            <h5 className="mb-2 text-xl tracking-tight text-[#5D6679] poppins-5">Slur Branch</h5>
                ...
                <div className="w-10/12 ml-10 mt-10 bg-white rounded-lg relative">
                    <a href="#" className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-full h-40 ">
                        <div className="relative w-full md:w-64 h-96 md:h-40">
                            <img className="object-cover w-full h-full rounded-t-lg md:rounded-none md:rounded-s-lg bg-slate-100 text-center" src="https://ml17qxtnn7dq.i.optimole.com/w:auto/h:auto/q:mauto/ig:avif/f:best/https://starstuffscience.com/wp-content/uploads/2019/07/Drogon-Melting-Throne.jpg" alt="Singular branch" />
                        </div>
                        <div className="flex flex-col justify-between p-4 leading-normal">
                            <h5 className="mb-2 text-xl tracking-tight text-[#5D6679] poppins-5">Gaandipuram Branch</h5>
